...
set_property PACKAGE_PIN V16 [get_ports scan_in_enable]
set_property IOSTANDARD LVCMOS33 [get_ports scan_in_enable]
set_property PACKAGE_PIN W16 [get_ports scan_in_data]
set_property IOSTANDARD LVCMOS33 [get_ports scan_in_data]
set_property PACKAGE_PIN W17 [get_ports scan_out_enable]
set_property IOSTANDARD LVCMOS33 [get_ports scan_out_enable]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports scan_out_data]
set_property IOSTANDARD LVCMOS33 [get_ports scan_out_data]
